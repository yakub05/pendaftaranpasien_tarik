            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Poli Umum</li>
                    ...
                    <div class="card-tools float-sm-right">
                        <form onsubmit="return confirm('Apakah Anda Yakin Untuk Mereset Data ?');" action="{{ route('poliumumdestroy') }}" method="POST">
                            @csrf
                            @method('DELETE')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <h3 class="card-title"><strong>Tabel Pasien Poli Umum</strong></h3>

                        <div class="card-tools">
                            <div class="project-actions" style="width: 120px;">
                                <a class="btn btn-warning btn-sm" href="/exportpoli/umum">
